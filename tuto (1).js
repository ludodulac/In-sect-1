...
function _placePiece(board, state) {
  ...
  el.innerHTML=state.piece.sym?`<img src='${state.piece.sym}' alt='' style='width:75%;height:75%;object-fit:contain;pointer-events:none;'>`:`<img src='reine_guepe_512.png' alt='' style='width:75%;height:75%;object-fit:contain;pointer-events:none;'>`;
}
...
function _placeEnemy(board, enemy, eid, diagIdx) {
  ...
  el.style.left=left; el.style.top=top; el.style.width=size; el.style.height=size;
  el.innerHTML=enemy.sym?`<img src='${enemy.sym}' alt='' style='width:75%;height:75%;object-fit:contain;pointer-events:none;'>`:`<img src='reine_guepe_512.png' alt='' style='width:75%;height:75%;object-fit:contain;pointer-events:none;'>`;
  board.appendChild(el);
}
...
function _placeCorpse(board, pos, n) {
  ...
  el.style.left=left; el.style.top=top; el.style.width=size; el.style.height=size;
  el.innerHTML=pos.sym?`<img src='${pos.sym}' alt='' style='width:75%;height:75%;object-fit:contain;pointer-events:none;'>`:`<img src='fourmi_512.png' alt='' style='width:75%;height:75%;object-fit:contain;pointer-events:none;'>`;
  board.appendChild(el);
}
