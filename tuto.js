...
const SYM = {
  queen:'reine_guepe_512.png', spider:'arraignee_512.png', fly:'mouche_512.png', beetle:'scarabee_512.png', lady:'coccinelle_512.png', ant:'fourmi_512.png',
};
...
const SLIDES = [
  ...
  /* 2 — ARAIGNÉE */
  {
    type: 'piece', sym: 'arraignee_512.png', name: `L'Araignée Assassine`,
...
function buildSpiderAnim() {
  return {
    piece:{r:2,c:1,color:'yellow',sym:'arraignee_512.png'},
...
function buildFlyAnim() {
  ...
  return {
    ...
    enemies:[
      ...
      {r:2,c:1,color:'blue',  sym:'arraignee_512.png'}, // ortho gauche
    ...
    enemiesDiag:[
      ...
      {r:1,c:3,color:'blue',  sym:'arraignee_512.png'},
...
function _buildContent(el, slide, idx) {
  if(slide.type==='intro') {
    ...
    el.innerHTML=`
      <div class="tuto-intro-icon"><img src="reine_guepe_512.png" alt="Reine" style="width:64px;height:64px;object-fit:contain;"></div>
  ...
  el.innerHTML=`
    <div class="tuto-piece-header">
      <div class="tuto-piece-sym"><img src="${slide.sym}" alt="" style="width:100%;height:100%;object-fit:contain;"></div>
...
function _placePiece(board, state) {
  ...
  el.innerHTML=state.piece.sym?`<img src='${state.piece.sym}' alt='' style='width:100%;height:100%;object-fit:contain;pointer-events:none;'>`:`<img src='reine_guepe_512.png' alt='' style='width:100%;height:100%;object-fit:contain;pointer-events:none;'>`;
}
...
function _placeEnemy(board, enemy, eid, diagIdx) {
  ...
  el.style.left=left; el.style.top=top; el.style.width=size; el.style.height=size;
  el.innerHTML=enemy.sym?`<img src='${enemy.sym}' alt='' style='width:100%;height:100%;object-fit:contain;pointer-events:none;'>`:`<img src='reine_guepe_512.png' alt='' style='width:100%;height:100%;object-fit:contain;pointer-events:none;'>`;
  board.appendChild(el);
}
...
function _placeCorpse(board, pos, n) {
  ...
  el.style.left=left; el.style.top=top; el.style.width=size; el.style.height=size;
  el.innerHTML=pos.sym?`<img src='${pos.sym}' alt='' style='width:100%;height:100%;object-fit:contain;pointer-events:none;'>`:`<img src='fourmi_512.png' alt='' style='width:100%;height:100%;object-fit:contain;pointer-events:none;'>`;
  board.appendChild(el);
}
