...
function _placePiece(board, state) {
  ...
  el.innerHTML=`<img src="${state.piece.sym||'reine_guepe_512.png'}" alt="" style="width:88%;height:88%;object-fit:contain;position:absolute;top:6%;left:6%;pointer-events:none;">`;
}
...
function _placeEnemy(board, enemy, eid, diagIdx) {
  ...
  el.style.left=left; el.style.top=top; el.style.width=size; el.style.height=size;
  el.innerHTML=`<img src="${enemy.sym||'fourmi_512.png'}" alt="" style="width:88%;height:88%;object-fit:contain;position:absolute;top:6%;left:6%;pointer-events:none;">`;
  board.appendChild(el);
}
...
function _placeCorpse(board, pos, n) {
  ...
  el.style.left=left; el.style.top=top; el.style.width=size; el.style.height=size;
  el.innerHTML=`<img src="${pos.sym||'fourmi_512.png'}" alt="" style="width:88%;height:88%;object-fit:contain;position:absolute;top:6%;left:6%;pointer-events:none;">`;
  board.appendChild(el);
}
